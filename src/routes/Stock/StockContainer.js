                    ...
                    <Row>
                        ...
                        >
                            <dl className="dl-horizontal m-b-0">
                                <dt>Open</dt>
                                <dd className="text-black">${ details.Details.Open }</dd>
                                <dt>High</dt>
                                <dd className="text-black">${ details.Details.High }</dd>
                                <dt>Low</dt>
                                <dd className="text-black">${ details.Details.Low }</dd>
                            </dl>
                        </Col>
                        <Col
                            lg={ 4 }
                        ...
                        >
                            <dl className="dl-horizontal m-b-0">
                                <dt>Market Cap</dt>
                                <dd className="text-black">${ details.Details.MarketCap }B</dd>
                                <dt>P/E ratio (ttm)</dt>
                                <dd className="text-black">${ details.Details.PERatio }</dd>
                                <dt>Divident Yield</dt>
                                <dd className="text-black">${ details.Details.DividentYield }</dd>
                            </dl>
                        </Col>
                    </Row>
                }
