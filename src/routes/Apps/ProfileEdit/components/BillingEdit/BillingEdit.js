                        ...
                        <Media>
                            <Media.Body>
                                <FormGroup>
                                    ...
                                    <Col sm={6}>
                                        <p>
                                            <span className='text-black'>Premium</span> - You use 37% of the available space
                                        </p>
                                ...
                                <FormGroup>
                                    ...
                                    <Col sm={9}>
                                        <p className='m-b-1'>
                                            ...
                                            <span className='text-black'>PayPal</span> - PayPal Account: { payPalUserName }
                                        </p>
                                        <dl className="dl-horizontal">
                                            <dt>Next Payment Due</dt>
                                            <dd className="text-black"> 2016-05-21 </dd>

                                            <dt>Amount</dt>
                                            <dd className="text-black">$ 13.00</dd>
                                        </dl>
                                    </Col>
                                </FormGroup>
                            </Media.Body>
                                ...
                                this.state.paymentModalType === 'credit' ? (
                                    <div>
                                        ...
                                        <FormGroup>
                                            ...
                                            <div>
                                                <i className="fa fa-fw fa-cc-visa fa-2x m-r-1 text-black"></i>
                                                <i className="fa fa-fw fa-cc-mastercard fa-2x m-r-1 text-black"></i>
                                                <i className="fa fa-fw fa-cc-discover fa-2x m-r-1 text-black"></i>
                                                <i className="fa fa-fw fa-cc-amex fa-2x m-r-1 text-black"></i>
                                                <i className="fa fa-fw fa-cc-jcb fa-2x m-r-1 text-black"></i>
                                            </div>
                                        </FormGroup>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            You are currently paying with your PayPal account <strong class="text-black"><span>Alanna.Nicolas@gmail.com</span></strong> Sign in to PayPal to use a different account.
                                        </p>
