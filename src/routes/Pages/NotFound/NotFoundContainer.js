                        ...
                        <Col className={ classes.centerCol } md={ 4 }>
                            ...
                            >
                                ...
                                <p className='text-center m-b-3'>
                                    Sorry but the page you are looking for ( <span className='text-black'>{this.props.location.pathname}</span> ) was not found. Try to fix the URL or use the search engine below.
                                </p>
                                <InputGroup>
                                    <FormControl
                                        type='text'
