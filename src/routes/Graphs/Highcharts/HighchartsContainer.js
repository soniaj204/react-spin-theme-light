        ...
        return (
            <div>
                <p className='m-t-1 m-b-3'>
                    <span className='text-black'>Create interactive charts easily for your web projects.</span> Used by tens of thousands of developers and 72 out of the world's 100 largest companies, Highcharts is the simplest yet most flexible charting API on the market.
                </p>
                <Row>
                    <Col lg={ 12 }>
                        <Panel
