                                    ...
                                    <Media>
                                        <Media.Left align='middle'>
                                            <span className="fa-stack fa-lg">
                                                ...
                                                <i className="fa fa-file-word-o fa-stack-1x fa-inverse text-black"></i>
                                            </span>
                                        </Media.Left>
                                        <Media.Body>
                                            <p className='text-black m-b-0'>
                                    ...
                                    <Media>
                                        <Media.Left align='middle'>
                                            <span className="fa-stack fa-lg">
                                                ...
                                                <i className="fa fa-file-excel-o fa-stack-1x fa-inverse text-black"></i>
                                            </span>
                                        </Media.Left>
                                        <Media.Body>
                                            <p className='text-black m-b-0'>
                                    ...
                                    <Media>
                                        <Media.Left align='middle'>
                                            <span className="fa-stack fa-lg">
                                                ...
                                                <i className="fa fa-file-text-o fa-stack-1x fa-inverse text-black"></i>
                                            </span>
                                        </Media.Left>
                                        <Media.Body>
                                            <p className='text-black m-b-0'>
                                    ...
                                    <Media>
                                        <Media.Left align='middle'>
                                            <span className="fa-stack fa-lg">
                                                ...
                                                <i className="fa fa-file-powerpoint-o fa-stack-1x fa-inverse text-black"></i>
                                            </span>
                                        </Media.Left>
                                        <Media.Body>
                                            <p className='text-black m-b-0'>
