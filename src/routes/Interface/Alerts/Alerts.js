                    ...
                    <Row>
                        <Col lg={ 6 }>
                            ...
                            <Alert bsStyle='success' noBackground>
                                <strong className='text-black'>Well Done!</strong> You successfully read this important alert message.
                            </Alert>
                            <Alert bsStyle='info' noBackground>
                                <strong className='text-black'>Heads Up!</strong> This alert needs your attention, but it's not super important.
                            </Alert>
                            <Alert bsStyle='warning' noBackground>
                                <strong className='text-black'>Warning!</strong> Better check yourself, you're not looking too good.
                            </Alert>
                            <Alert bsStyle='danger' noBackground>
                                <strong className='text-black'>Oh Snap!</strong> Change a few things up and try submitting again.
                            </Alert>
