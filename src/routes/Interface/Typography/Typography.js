                ...
                <Col md={12}>
                    ...
                    <Row>
                        <Col lg={ 4 }>
                            ...
                            <p className="text-black">This is an example of White Text.</p>
                    ...
                    <Row>
                        <Col lg={ 6 }>
                            <dl>
                                <dt className="text-black">Description lists</dt>
                                <dd>A description list is perfect for defining terms.</dd>
                                <dt className="text-black">Euismod</dt>
                                <dd>Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.</dd>
                                <dd>Donec id elit non mi porta gravida at eget metus.</dd>
                                <dt className="text-black">Malesuada porta</dt>
                        ...
                        <Col lg={ 6 }>
                            <dl className='dl-horizontal'>
                                ...
                                <dt className="text-black">Malesuada porta</dt>
                                <dd>Etiam porta sem malesuada magna mollis euismod.</dd>
                                <dt className="text-black">Felis euismod semper eget lacinia</dt>
