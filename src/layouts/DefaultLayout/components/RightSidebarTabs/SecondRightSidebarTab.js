    ...
    <div className='m-t-2'>
        ...
        <ListGroup className={ classes.list }>
            <ListGroupItem className={ `${classes.listEntry} ${classes.flexSpaceBetween}` }>
                ...
                <i className='fa fa-fw fa-sort text-black'></i>
            </ListGroupItem>
            <ListGroupItem className={ `${classes.listEntry} ${classes.flexSpaceBetween}` }>
                <span className='small'>IP</span>
                <span className='small text-black'>{ lan.Ip }</span>
            </ListGroupItem>
            <ListGroupItem className={ `${classes.listEntry} ${classes.flexSpaceBetween}` }>
                <span className='small'>MAC</span>
                <span className='small text-black'>{ lan.Mac }</span>
            </ListGroupItem>
            <ListGroupItem className={ `${classes.listEntry} ${classes.flexSpaceBetween}` }>
                <i className='fa fa-long-arrow-down'></i>
                <div>
                    <span className='small text-black m-r-1'>
            ...
            <ListGroupItem className={ `${classes.listEntry} ${classes.flexSpaceBetween}` }>
                <i className='fa fa-long-arrow-up text-black'></i>
                <div>
                    <span className='small text-black m-r-1'>
            ...
            _.map(machines, (machine, index) => (
                <ListGroupItem key={ machine._id }>
                    ...
                    <p className='m-y-0 small'>
                        <strong className='text-black'>{ machine.Space.Used } GB </strong>
                        <span> / </span>
